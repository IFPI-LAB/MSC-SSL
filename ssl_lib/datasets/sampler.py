...
class ImbalancedDatasetSampler(torch.utils.data.sampler.Sampler):
    ...
    def _get_labels(self, dataset):
        ...
        elif isinstance(dataset, ssl_lib.datasets.dataset_class.LabeledDataset):
            return dataset.dataset['labels']
        else:
            raise NotImplementedError

    def __iter__(self):
        temp = (self.indices[i] for i in torch.multinomial(self.weights, self.num_samples, replacement=True))
