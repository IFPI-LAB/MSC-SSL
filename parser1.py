...
def default_parser():
    ...
    parser.add_argument("--num_unlabels", default=-1, type=int, help="number of unlabeled data")  # If num_unlabels<0, use all training datasets as unlabeled samples
    ...
    parser.add_argument('--per_epoch_steps', type=int, default=100, help='number of training images for each epoch')
    ...
    parser.add_argument('--reg_warmup_iter', type=int, default=100)
    parser.add_argument('--lmmd_feat_table_l', type=int, default=128, help='feat size for mmd table')
    parser.add_argument('--lmmd_feat_table_u', type=int, default=128, help='feat size for mmd table')
